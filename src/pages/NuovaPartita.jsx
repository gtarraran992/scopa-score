...
export default function NuovaPartita({ user }) {
  ...
  return (
    <div className="page">
      ...
      <div className="card" style={{ marginBottom: '28px', padding: '16px' }}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <span style={{ fontSize: '15px', color: 'var(--text-muted)' }}>Target</span>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0', background: 'var(--ink-muted)', borderRadius: 'var(--radius-md)', overflow: 'hidden' }}>
